...
public class UsrProductController {
	...
	@RequestMapping("/usr/product/Redwine")	
	public String showRedwinetList(HttpServletRequest req, Model model, @RequestParam(defaultValue = "1") int boardId,
			@RequestParam(defaultValue = "1") int page,
			@RequestParam(defaultValue = "productName,body") String searchKeywordTypeCode,
			@RequestParam(defaultValue = "") String searchKeyword) {
		...
		return "usr/product/Redwine";
	}

	@RequestMapping("/usr/product/Sparklingwine")	
	public String showSparklingwinetList(HttpServletRequest req, Model model, @RequestParam(defaultValue = "1") int boardId,
			@RequestParam(defaultValue = "1") int page,
			@RequestParam(defaultValue = "productName,body") String searchKeywordTypeCode,
			@RequestParam(defaultValue = "") String searchKeyword) {
		...
		return "usr/product/Sparklingwine";
	}
	
	@RequestMapping("/usr/product/Whitewine")	
	public String showWhitewinetList(HttpServletRequest req, Model model, @RequestParam(defaultValue = "1") int boardId,
			@RequestParam(defaultValue = "1") int page,
			@RequestParam(defaultValue = "productName,body") String searchKeywordTypeCode,
			@RequestParam(defaultValue = "") String searchKeyword) {
